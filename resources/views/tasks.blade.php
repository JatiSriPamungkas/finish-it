<x-layout>
    ...
    <div class="w-full grid grid-cols-1 gap-4 lg:grid-cols-3 lg:gap-8">
        ...
        <div class="h-42 p-8 rounded-sm flex gap-8 items-center bg-white shadow-md text-gray-700">
            <div class="h-18 bg-amber-100 rounded-sm p-2">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                    stroke="currentColor" class="size-12 text-amber-500">
                    <path stroke-linecap="round" stroke-linejoin="round"
    ...
    <div class="flex flex-col gap-6">
        ...
        <fieldset class="border border-b-0 border-gray-300 rounded-sm">
            ...
            <div class="flex flex-col items-start">
                <label
                    class="w-full flex items-center justify-between px-8 py-4 rounded-sm border-b border-gray-300 bg-white">
                    <div class="flex items-center gap-4">
                        <input type="checkbox" class="my-0.5 size-5 rounded border-gray-300 shadow-sm">

                        <div>
                            <span class="font-medium text-gray-700">Setup Database</span>
                ...
                <label
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            <span class="font-medium text-gray-700">Create Landing Page</span>
                            <p class="mt-0.5 text-sm text-gray-700">
                                Web Redesign
                            </p>
                        </div>
